...
function AddArtistLead() {
  ...
  return (
    ...
    >
      <div className="artist-two-column-layout">
        <div className="artist-form-card artist-form-card--full">
        ...
        <div className="artist-side-panel">
          <div className="ah-section-heading artist-side-panel-heading">
            Preview
          </div>
