      ...
      <div className="scene-form-card">
        ...
        {createdIncident && (
          <div className="message-box success">
            ...
            {createdIncident.uploadWarning && (
              <>
                <br />
                <span>{createdIncident.uploadWarning}</span>
              </>
            )}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="form-grid compact-form">
          <div className="form-group">
            ...
            {errors.incidentType && <small className="field-error">{errors.incidentType}</small>}
          </div>
          ...
          <div className="form-group">
            ...
            />
            {errors.reportedBy && <small className="field-error">{errors.reportedBy}</small>}
          </div>
          ...
          <div className="form-group">
            ...
            {errors.placeAreaId && <small className="field-error">{errors.placeAreaId}</small>}
          </div>
          ...
          <div className="form-group full-span">
            ...
            />
            {errors.exactLocation && <small className="field-error">{errors.exactLocation}</small>}
          </div>
